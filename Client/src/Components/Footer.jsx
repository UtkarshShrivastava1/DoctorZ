  ...
  return (
    <footer className=" w-full bg-[#0f172a] text-white py-10 border-t border-gray-700">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        {/* Logo & About */}
        <div>
          <h2 className="text-2xl font-bold text-blue-500">MediAid</h2>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            ...
            <li><a href="/userDashboard/about" className="hover:text-blue-500 transition">About Us</a></li>
            <li><a href="/doctors" className="hover:text-blue-500 transition">Doctors</a></li>
            <li><a href="/labs" className="hover:text-blue-500 transition">Labs</a></li>
        ...
        <div>
          ...
          <p className="text-gray-400">✉️ support@mediaid.com</p>
        </div>

  ...
  const services = [
    {
      ...
      description:
        "Immediate medical attention when you need it most, available around the clock.",
    ...
    },
    {
      ...
      description:
        "Book appointments seamlessly with our intelligent scheduling system.",
    ...
    },
    {
      ...
      description:
        "Complete healthcare solutions tailored to your individual needs.",
  ...
  const features = [
    {
      ...
      description:
        "Rapid emergency medical services with advanced life support capabilities.",
    },
    {
      icon: <Plus className="w-8 h-8" />,
      title: "Digital Pharmacy",
      description:
        "Modern pharmaceutical services with digital prescriptions and home delivery.",
    },
    {
      icon: <Stethoscope className="w-8 h-8" />,
      title: "Expert Treatment",
      description:
        "World-class medical treatments using cutting-edge technology and protocols.",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-2xl">
                Experience world-class medical care with our innovative
                platform. We combine expert healthcare with modern technology to
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service) => (
              ...
              >
                ...
                {/* Icon */}
                <div
                  className={`inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br ${service.gradient} rounded-xl text-white mb-6 group-hover:scale-110 transition-transform duration-200`}
                >
                  {service.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-gray-600">
              Our comprehensive healthcare platform combines cutting-edge
              technology with compassionate care to deliver exceptional medical
              services.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 sm:p-12 text-center text-white">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-blue-100 text-lg mb-8">
                ...
                healthcare needs. Experience the difference of personalized,
